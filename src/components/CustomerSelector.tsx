  ...
  return (
    <form onSubmit={handleCreate} className="p-3 border-t border-[var(--border-subtle)] space-y-2">
      ...
      <input
        ...
        required
        className="w-full px-2.5 py-1.5 text-sm rounded-md bg-[var(--bg-primary)] border border-[var(--border-subtle)] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-primary)]"
      />
      <input
        type="text"
        value={company}
    ...
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className={`w-full flex items-center justify-between gap-2 px-3 py-2 text-sm rounded-md border transition-colors text-left ${
          open
            ? "border-[var(--accent-primary)] ring-1 ring-[var(--accent-primary)] bg-[var(--bg-primary)]"
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute z-50 mt-1 w-full rounded-md border border-[var(--border-subtle)] bg-[var(--bg-secondary)] shadow-xl overflow-hidden">
          {/* Search */}
          <div className="p-2 border-b border-[var(--border-subtle)]">
            <div className="relative">
              <svg className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)]" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
              ...
              <input
                ...
                className="w-full pl-7 pr-3 py-1.5 text-sm rounded bg-[var(--bg-primary)] border border-[var(--border-subtle)] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-primary)]"
              />
            </div>
          </div>
