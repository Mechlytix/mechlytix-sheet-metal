...
export function CustomerQuoteView({ quote, shopProfile, displayToken }: { quote: any; shopProfile: any; displayToken: string }) {
  ...
  const mach = quote.machine_profiles;
        ...
        {!isExpired && quote.status !== "rejected" && (
          <div className="qs-cta">
            ...
            <p>
              ...
              Reference: <strong>{displayToken}</strong>
            </p>
